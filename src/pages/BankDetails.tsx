...
const BankDetails = () => {
  ...
  return (
    <>
      ...
      <Layout>
        <Chatbot />
        <div ref={contentRef} className="min-h-screen bg-transparent p-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Bank Header */}
            <Card className="mb-8 border-0 shadow-xl bg-white/90 backdrop-blur-md rounded-2xl">
              <CardContent className="p-8">
                <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
                  <div className="flex items-center gap-6">
                    <div className="w-16 h-16 flex items-center justify-center shadow-lg bg-white border border-gray-200 rounded-full">
                      <img src={`/logos/${bankId}.png`} alt={meta.name} className="w-16 h-16 object-contain" />
                    </div>
                    <div>
                      <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 drop-shadow">{meta.name}</h1>
                  ...
                  <div className="text-right">
                    ...
                    <div className={`flex items-center gap-1 text-lg font-semibold ${forecastChange !== null ? (forecastChange > 0 ? 'text-green-600' : 'text-red-600') : 'text-gray-500'}`}>{forecastChange !== null ? `${forecastChange > 0 ? '+' : ''}${forecastChange.toFixed(2)}%` : 'N/A'}</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Price Chart */}
              <Card className="lg:col-span-2 border-0 shadow-xl bg-white/90 backdrop-blur-md rounded-2xl">
                <CardHeader>
            ...
            <div className="mb-12 mt-12 w-full overflow-x-auto">
              <Card className="border-0 shadow-xl bg-white/90 backdrop-blur-md p-6 min-w-[350px] rounded-2xl">
                <CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-8">
              <div className="bg-white/90 rounded-2xl shadow-xl p-6 flex flex-col items-center w-full max-w-xs mx-auto">
